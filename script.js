// ================================================================
// script.js – पूरा JavaScript Logic
// ================================================================
...
(function() {
  ...
  // ════════════════════════════════════════════════════════════════
  const GAS_URL = 'https://script.google.com/macros/s/AKfycbwWk1daKxwr212qwoo3YHJRI2_-t9yGtAxxPQgA2TZMTXEYKFJQc4zH2cQcqErMSDq4yw/exec';
  ...
  function registerSW() {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register('sw.js')
        ...
        .catch(function() { console.warn('SW reg failed'); });
    }
  }

  function triggerSync() {
    if (swRegistration && 'sync' in swRegistration) {
      swRegistration.sync.register('photo-sync').catch(function() {});
    }
  }
  ...
  async function capturePhoto() {
    ...
    var filename = 'photo_' + timestamp + '.png';
    ...
    try {
      ...
      for (var i = 0; i < pending.length; i++) {
        ...
        try {
          ...
          console.warn('⏳ Retry later:', entry.filename, err.message);
  ...
  function setOnline(online) {
    ...
    if (online) {
      setTimeout(checkPendingQueue, 1000);
    }
  }
